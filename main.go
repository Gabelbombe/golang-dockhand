...
import (
	...
	"github.com/ehime/golang-dockhand/docker"
	"github.com/ehime/golang-dockhand/jenkins"
)

var (
	dockerHostURL    = flag.String("dockerurl", "tcp://abs.ehimeprefecture.com:2376", "the full address to the docker Jenkins host: tcp://<address>:<port>")
	...
	registryURL      = flag.String("registry", "https://abs-registry.ehimeprefecture.com", "The URL of the registry of where to find the image we are testing.")
	...
	imageName        = flag.String("imagename", "dockerbuild.ehimeprefecture.com/jenkins-slavedotnet", "The name of the image we are testing.")
	...
	jenkinsURL       = flag.String("jenkinsurl", "http://dockerbuild.ehimeprefecture.com", "The URL of the Jenkins Master.")
	jenkinsUser      = flag.String("jenkinsuser", "ehime", "A user with rights to the registry we are pulling the test image from.")
	jenkinsPassword  = flag.String("jenkinspassword", "correcthorsebatteystaple", "The password of the registry user")
	repoURL          = flag.String("repourl", "https://github.com/ehime/simpleDotNet.git", "The repo url.")
